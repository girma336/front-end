...
Welcome to the frontend repository of Juubix!
...
- Copy this link `https://github.com/JUUBIX1/front-end`
...
- Copy environment variables and update variables respectively

```bash
cp .env.example .env.local
```

## Set up shared-auth submodule

- Checkout Submodule and run this once

```bash
git submodule update --init --recursive --remote
```

- To pull latest updates on submodule, run
